...
public class RegistrationTool {
    ...
    @McpTool(
            ...
            description = """
                    ...
                    今回の領収書を経費として登録するよう、ユーザーが明示的に依頼している場合にのみ使用してください。
                    経費科目の判定だけを求められた場合は、経費登録を提案したり確認したりせず、このToolを呼び出さないでください。
                    ...
                    確認文は「今回の領収書を経費として登録してよいですか？」のように、経費登録であることを明示してください。
                    ナレッジ登録への同意や、「登録して」という対象が曖昧な返答は、経費登録への同意として扱わないでください。
                    ...
                    register_expense_knowledge と同じ応答で呼び出さないでください。
